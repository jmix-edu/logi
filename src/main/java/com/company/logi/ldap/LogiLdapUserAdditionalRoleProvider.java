...
@Component
public class LogiLdapUserAdditionalRoleProvider implements LdapUserAdditionalRoleProvider {

    private final RowLevelRoleRepository rowLevelRoleRepository;
    private final RoleGrantedAuthorityUtils grantedAuthorityUtils;

    public LogiLdapUserAdditionalRoleProvider(RowLevelRoleRepository rowLevelRoleRepository,
